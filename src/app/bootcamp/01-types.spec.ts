...
describe('literals in TypeScript', () => {
    ...
    it('some things about strings', () => {
        const myName = 'Bhargavi';

        expect(`The name is ${myName}`).toBe('The name is Bhargavi');
    ...
    describe('tuples', () => {
        ...
        it('formatting a name with tuple', () => {
            type FormattedNameResult = [string, number];
              // function formatName(first: string, last: string): [string, number] {// anaymous tuple
            function formatName(first: string, last: string): FormattedNameResult {// named tuple
                  const fullName = `${last},{first}`;
